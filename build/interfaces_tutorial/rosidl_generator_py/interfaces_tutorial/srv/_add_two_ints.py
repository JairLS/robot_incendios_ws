...
class AddTwoInts_Event(metaclass=Metaclass_AddTwoInts_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<interfaces_tutorial/AddTwoInts_Request, 1>',
        'response': 'sequence<interfaces_tutorial/AddTwoInts_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['interfaces_tutorial', 'srv'], 'AddTwoInts_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['interfaces_tutorial', 'srv'], 'AddTwoInts_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from interfaces_tutorial.srv import AddTwoInts_Request
    ...
    def response(self, value):
        if self._check_fields:
            from interfaces_tutorial.srv import AddTwoInts_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces_tutorial.srv.AddTwoInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from interfaces_tutorial.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from interfaces_tutorial.srv._add_two_ints import AddTwoInts_Request as Request
    from interfaces_tutorial.srv._add_two_ints import AddTwoInts_Response as Response
    from interfaces_tutorial.srv._add_two_ints import AddTwoInts_Event as Event
