...
#include "interfaces_tutorial/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces_tutorial::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_tutorial::msg::Num & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_tutorial::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces_tutorial::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_tutorial::msg::Num *>(
    untyped_ros_message);
...
get_message_type_support_handle<interfaces_tutorial::msg::Num>()
{
  return &interfaces_tutorial::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_tutorial, msg, Num)() {
  return &interfaces_tutorial::msg::typesupport_fastrtps_cpp::_Num__handle;
}
